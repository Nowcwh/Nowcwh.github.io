...
2. **Wenhui Chen**, Mengmeng Sun, Yuesheng Xu, et al., Functional Complementarity-aware Representation Learning for Cold-start Recommendation in Mashup Creation, *IEEE Transactions on Consumer Electronics*, **SCI Q2, IF: 10.9**, 2026.

3. **Wenhui Chen**, Jirui Liu, Bin Li, et al., Multi-Graph Contrastive Learning With LLM-Empowered Semantic Augmentation for E-commerce Recommendation, *IEEE Transactions on Consumer Electronics*, **SCI Q2, IF: 10.9**, 2025.

4. **Wenhui Chen**, Xiangze Jiang, Zhenyan Ji, et al., RFPillarNext: Geometry-aware 3D Object Detection for Dynamic LiDAR Point Clouds, *The Visual Computer*, **SCI Q3, IF: 2.9**, 2025.

5. Zhen Chen, **Wenhui Chen**, Xiaowei Liu, et al., CCeACF: Content and Complementarity Enhanced Attentional Collaborative Filtering, *The Journal of Supercomputing*, **SCI Q3, IF: 2.7; Advisor first author; Wenhui Chen second author**, 2024.
...
2. *Dec. 2025 - Present*, Research on the Mechanism and Methods for Collaborative Factor-based Marshalling Station Operation Planning, **National Natural Science Foundation of China Joint Fund Project**, Role: Participant, PI: Shiwei He.

3. *Dec. 2025 - Present*, Research on Key Technologies for Cybersecurity Risk Monitoring and Early Warning, **Natural Science Horizontal Project**, Role: Participant, PI: Zhenyan Ji.

4. *Mar. 2025 - Present*, Software Development Assistant, **Natural Science Horizontal Project**, Role: Participant, PI: Zhenyan Ji.

5. *Jan. 2023 - Dec. 2025*, Research on Cloud API Complementary Recommendation Problems in Service-Oriented Software Development, **Central Government Guided Local Science and Technology Development Fund Project**, Role: Participant, PI: Zhen Chen.
...
- *2022*, Second Prize, China Collegiate Programming Contest, Hebei Provincial Contest.
- *2022*, Third Prize, "Huawei Cup" China Graduate Mathematical Contest in Modeling.
- *2018*, National Encouragement Scholarship.
- *2018*, Silver Medal, Shandong Collegiate Programming Contest.
